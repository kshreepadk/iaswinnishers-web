  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-3">
      <a
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-soft transition-transform hover:scale-110"
      >
      ...
      <a
        href={`tel:${PHONE}`}
        aria-label="Call now"
        className="flex h-14 w-14 items-center justify-center rounded-full bg-ink shadow-soft transition-transform hover:scale-110"
      >
