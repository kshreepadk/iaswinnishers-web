  ...
  return (
    <>
      ...
      <a
        href={`tel:${PHONE}`}
        aria-label="Call now"
        className="fixed bottom-6 left-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-ink shadow-soft transition-transform hover:scale-110 sm:bottom-8 sm:left-5 sm:h-14 sm:w-14"
      >
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="sm:h-6 sm:w-6">
      ...
      <a
        ...
        className="group fixed bottom-6 right-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-soft transition-transform hover:scale-110 sm:bottom-8 sm:right-5 sm:h-14 sm:w-14"
      >
        <span className="absolute inset-0 animate-ping rounded-full bg-[#25D366] opacity-40" />
        <svg width="24" height="24" viewBox="0 0 24 24" fill="#fff" className="relative sm:h-7 sm:w-7">
