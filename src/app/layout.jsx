        ...
        <div className="bg-coral-dark text-white text-sm">
          <div className="mx-auto flex max-w-[1200px] flex-wrap items-center justify-between gap-3 px-6 py-2.5">
            <div className="flex flex-wrap items-center gap-5">
              ...
              <a href="mailto:vinayenterprising@gmail.com" className="hidden items-center gap-1.5 opacity-90 hover:opacity-100 hover:text-marigold sm:flex">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                aria-label="Facebook"
                className="flex h-6 w-6 items-center justify-center rounded-full bg-white/15 transition-colors hover:bg-white hover:text-coral-dark"
              >
